...
class Manager::InterviewsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { stats: @interview.stats } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { stats: @interview.stats } }
